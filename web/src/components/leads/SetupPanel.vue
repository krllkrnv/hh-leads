...
<template>
  <section :class="$style.SetupPanel">
    <header :class="$style.masthead">
      <BrandTitle />
      <p :class="$style.lead">
        Разбор переписок с работодателями на hh.ru: приглашения, тестовые и то, где ещё
        ожидается ответ. Чаты подтягиваются по cookie из браузера. Если отчёт уже скачан из
