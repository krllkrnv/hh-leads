...
Дашборд и CLI для разбора переписок с работодателями на [hh.ru](https://hh.ru): забирает чаты через Chatik API, классифицирует лиды и показывает их в интерфейсе или выгружает в Excel.
